function click_home()
  ...
  function click_about()
  {
    ...
    document.getElementById('box-about').style.display = 'initial';
    document.getElementById('box-curriculum').style.display = 'none';
    document.getElementById('box-portfolio').style.display = 'none';
    document.getElementById('box-blog').style.display = 'none';
    document.getElementById('box-contact').style.display = 'none';
  ...
  function click_cur()
  {
    document.getElementById('box-home').style.display = 'none';
    document.getElementById('box-about').style.display = 'none';
    document.getElementById('box-curriculum').style.display = 'initial';
    document.getElementById('box-portfolio').style.display = 'none';
    document.getElementById('box-blog').style.display = 'none';
    document.getElementById('box-contact').style.display = 'none';
    document.getElementById('box-twitter').style.display = 'none';
  ...
  function click_portfolio()
  {
    ...
    document.getElementById('box-about').style.display = 'none';
    document.getElementById('box-curriculum').style.display = 'none';
    document.getElementById('box-portfolio').style.display = 'initial';
    document.getElementById('box-blog').style.display = 'none';
    document.getElementById('box-contact').style.display = 'none';
    document.getElementById('box-twitter').style.display = 'none';
    document.getElementById('box-instagram').style.display = 'none';
  ...
  function click_blog()
  {
    ...
    document.getElementById('box-curriculum').style.display = 'none';
    document.getElementById('box-portfolio').style.display = 'none';
    document.getElementById('box-blog').style.display = 'initial';
    document.getElementById('box-contact').style.display = 'none';
    document.getElementById('box-twitter').style.display = 'none';
    document.getElementById('box-instagram').style.display = 'none';
    document.getElementById('box-face').style.display = 'none';
  ...
  function click_face()
  {
    ...
    document.getElementById('box-twitter').style.display = 'none';
    document.getElementById('box-instagram').style.display = 'none';
    document.getElementById('box-face').style.display = 'initial';
  ...
  function click_twitter()
  {
    ...
    document.getElementById('box-blog').style.display = 'none';
    document.getElementById('box-contact').style.display = 'none';
    document.getElementById('box-twitter').style.display = 'initial';
    document.getElementById('box-instagram').style.display = 'none';
    document.getElementById('box-face').style.display = 'none';
  
  }
  function click_insta()
  {
    document.getElementById('box-home').style.display = 'none';
    document.getElementById('box-about').style.display = 'none';
    document.getElementById('box-curriculum').style.display = 'none';
    ...
    document.getElementById('box-contact').style.display = 'none';
    document.getElementById('box-twitter').style.display = 'none';
    document.getElementById('box-instagram').style.display = 'initial';
    document.getElementById('box-face').style.display = 'none';
